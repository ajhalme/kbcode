...
volatile uint8_t incoming_byte=0; // TODO: bits
volatile int adc_high_gain;
volatile int adc_low_gain;
volatile uint8_t incoming_byte_value;
volatile uint8_t message_incoming=0; // TODO: bits
volatile uint8_t incoming_message[5];
volatile uint8_t leading_bit=1; // TODO: bits
volatile int txvalue_buffer[7][4];
volatile uint8_t txvalue_buffer_pointer; // TODO: bits
...
// volatile int clock_1=0; // TODO: redundant?
volatile uint16_t clock_2=0;
// volatile int clock_3=0;  // TODO: redundant?
...
volatile uint8_t special_mode_message=3;
volatile uint8_t special_mode=1; // TODO: bits
volatile uint8_t special_message_buffer[3]; // TODO: bits
volatile uint8_t special_message_pointer=0; // TODO: bits
volatile uint8_t wakeup=0; // TODO: bits
